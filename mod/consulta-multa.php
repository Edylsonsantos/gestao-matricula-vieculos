...
// Verifica se a placa foi passada como parâmetro
$placa_parametro = isset($_GET['placa']) ? $_GET['placa'] : null;

if ($placa_parametro) {
    // Consulta as multas, filtrando por placa
    ...
    $stmt_consulta->bind_param("s", $placa_parametro);
    ...
    <div class="sidebar">
        ...
        <div class="content">
            ...
            <?php if ($consulta_result && $consulta_result->num_rows > 0): ?>
                <h3>Multas para a placa: <?php echo htmlspecialchars($placa_parametro); ?></h3>
                <table>
                    <tr>
                        <th>ID</th>
                        <th>Motivo</th>
            ...
            <?php else: ?>
                <p class="warning">Nenhuma multa encontrada para a placa informada.</p>
            <?php endif; ?>
        </div>
    </div>
